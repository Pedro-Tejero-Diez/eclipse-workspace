...
static Scanner sc= new Scanner(System.in);
	...
	public static void eliminarClientes(ArrayList<Cliente>clientes, String name, String lastName) {
		System.out.println("Introduzca Nombre Cliente");
		String name1 = sc.nextLine();
		System.out.println("Introduzca Apellido Cliente");
		String lastName1 = sc.nextLine();
		if (buscarCliente(clientes, name1, lastName1) ==null) {
			System.out.println("El cliente "+name1+"  "+lastName1+" ya está en nuestra base de datos");
		} else {
			
			clientes.add(buscarCliente(clientes, name1, lastName1));
		}
	}
